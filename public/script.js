...
this
    ...
    welcome:
    {
        ...
        is_name: true,
        mes: [
            '<h2>Welcome to SillyTavern v1.9.7!</h2>',
            '<div id="version_display_welcome"></div>',
            '<h3>20230813 K启源魔改版1.9.7，群号：874312014</h3>',
            '<ul>',
            '<li><font color="green">增加面板写入Claude2.0 sessionKey信息，无需修改配置文件</font></li>',
            `<li>如果报错：Couldn't get account info have you set your cookie? 不需要修改任何配置文件，直接在酒馆页面里面找倒数第三个配置项在倒数第三个配置项里的sessionKey配置项中粘贴最新的key然后保存即可，刷新页面</li>`,
            '</ul>',
            '<img src="/img/a.png"/>',
            '<hr>'
        ].join('')
